...
Lapidary 기획문서를 읽기 쉬운 단위로 분리한 문서 모음입니다.
...
- [08. 확장/MVP 정의/톤](./08-future-mvp-priorities-tone.md): 향후 확장, 최종 MVP 정의, 추천 우선순위, 제품 톤앤매너, 요약

## 추천 읽기 순서

1. 제품 방향을 확인할 때: `01-product-overview.md`, `08-future-mvp-priorities-tone.md`
2. 구현 범위를 정할 때: `02-mvp-and-ux.md`, `07-roadmap-tests-ai-risks.md`
3. 백엔드/파일 작업을 구현할 때: `03-tech-architecture-data.md`, `04-api-design.md`, `05-files-markdown-search-performance.md`
4. 운영과 품질 기준을 확인할 때: `06-state-errors-operations.md`, `07-roadmap-tests-ai-risks.md`
